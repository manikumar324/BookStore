  ...
  return (
    <div className='bg-custom-dark'>
        ...
        <div className='flex justify-between items-center text-white mb-2'>
            ...
            <Lottie animationData={topPicks} className='h-[50px]' />
        </div>
        ...
        <div className='flex gap-[10px] overflow-x-scroll scrollbar-hide'>
            ...
            {!showAll && TopPicks.length > 5 &&(
                ...
                className='w-[124px] h-[216px] flex-shrink-0 bg-[#222227] flex flex-col relative'
                >
                <img 
                src={view}
                alt='view'
                className='flex-shrink-0 text-white bg-[#0067B3] p-3 rounded-full w-[48px] h-[48px] absolute top-[78px] left-[35px]'
                />
                <p className='text-[#A9ADB9] text-xs font-semibold w-[65px] h-[16px] absolute top-[132px] left-[30px]'>
                    View More
                </p>
                </button>
            )}
